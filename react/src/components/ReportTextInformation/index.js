...
const ReportTextInformation = (props) => (
    <form className="container">
        ...
        <label className="pt-label">
            Location
            <input className="pt-input" readOnly value={props.individual.location} dir="auto"/>
        </label>
        <label className="pt-label">
            Place of birth
            <input className="pt-input" readOnly value={props.individual.place_of_birth} dir="auto"/>
        </label>
        <label className="pt-label">
            nationalities
            <input className="pt-input readOnly" readOnly value={beautifyNationalities(props.individual.nationalities)} />
        </label>
        <label className="pt-label">
            nationalities
            <input className="pt-input readOnly" readOnly value={beautifyIdentifications(props.individual.identifications)} />
        </label>
        <label className="pt-label">
          Report
          <textarea className="pt-input readOnly" readOnly dir="auto" value={props.individual.report} />
        </label>
        <label className="pt-label">
          Sources
          <textarea className="pt-input readOnly" readOnly dir="auto" value={props.individual.sources} />
        </label>
    </form>
);
